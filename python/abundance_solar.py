...
class AbundanceSolar(object):
    def __init__(self, nHe_nH=9.55e-2, Zprime=1.0):
    ...
    def get_XYZ_muH_mu(self):
        ...
        # Fully atomic
        mu_ato = df['MX_MH'].sum()/df['NX_NH'].sum()
